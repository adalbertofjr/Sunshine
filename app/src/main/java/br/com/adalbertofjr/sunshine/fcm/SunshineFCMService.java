package br.com.adalbertofjr.sunshine.fcm;
...
public class SunshineFCMService extends FirebaseMessagingService {
    private static final String LOG_TAG = SunshineFCMService.class.getSimpleName();

    public SunshineFCMService() {
    }
...
// message, here is where that should be initiated. See sendNotification method below.
    ...
    private void sendNotification(String messageBody) {
        ...
        NotificationCompat.Builder notificationBuilder = new NotificationCompat.Builder(this)
                ...
                .setContentTitle("Sunshine FCM Message")
